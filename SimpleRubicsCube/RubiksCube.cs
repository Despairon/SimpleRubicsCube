...
namespace SimpleRubicsCube
{
    ...
    public abstract class RubiksCube
    {
        public static void buildCube()
        {
            ...
            for (int i=0; i<3; i++)
                for (int j=0; j<3; j++)
                {
                    ...
                    botMatrix  [i, j] = cubeMatrix[i, j, 2];
                }
        ...
        private static CubeSide frontSide;
        private static CubeSide middleSide;
        private static CubeSide farSide;
        ...
        public static void init()
        {
            ...
            frontSide.left.midPiece = new Render.CubePiece((int)colors.BLUE, (int)sides.FRONT,
                                                             ...
                                                             (int)colors.BLACK, (int)sides.RIGHT,
                                                              1, 0, -1);
            frontSide.left.botPiece = new Render.CubePiece((int)colors.YELLOW, (int)sides.BOTTOM,
                                                             (int)colors.BLUE, (int)sides.FRONT,
                                                             (int)colors.RED, (int)sides.LEFT,
                                                              1, -1, -1);
            ...
            frontSide.right.topPiece = new Render.CubePiece((int)colors.WHITE, (int)sides.TOP,
                                                            (int)colors.BLUE, (int)sides.FRONT,
            ...
            frontSide.right.midPiece = new Render.CubePiece((int)colors.BLUE, (int)sides.FRONT,
                                                             ...
                                                             -1, 0, -1);
            frontSide.right.botPiece = new Render.CubePiece((int)colors.YELLOW, (int)sides.BOTTOM,
                                                            (int)colors.BLUE, (int)sides.FRONT,
                                                            (int)colors.ORANGE, (int)sides.RIGHT,
                                                             -1, -1, -1);
            ...
            farSide.left.topPiece = new Render.CubePiece((int)colors.WHITE, (int)sides.TOP,
                                                         (int)colors.GREEN, (int)sides.BACK,
                                                         (int)colors.RED, (int)sides.LEFT,
                                                               1, 1, 1);
            farSide.left.midPiece = new Render.CubePiece((int)colors.GREEN, (int)sides.BACK,
                                                         (int)colors.RED, (int)sides.LEFT,
                                                         (int)colors.BLACK, (int)sides.FRONT,
                                                               1, 0, 1);
            farSide.left.botPiece = new Render.CubePiece((int)colors.YELLOW, (int)sides.BOTTOM,
                                                         (int)colors.GREEN, (int)sides.BACK, 
                                                         (int)colors.RED, (int)sides.LEFT,
                                                               1, -1, 1);
            ...
            farSide.right.topPiece = new Render.CubePiece((int)colors.WHITE, (int)sides.TOP,
                                                          (int)colors.GREEN, (int)sides.BACK,
                                                          (int)colors.ORANGE, (int)sides.RIGHT,
                                                              -1, 1, 1);
            farSide.right.midPiece = new Render.CubePiece((int)colors.GREEN, (int)sides.BACK,
                                                              ...
                                                              (int)colors.BLACK, (int)sides.LEFT,
                                                              -1, 0, 1);
            farSide.right.botPiece = new Render.CubePiece((int)colors.YELLOW, (int)sides.BOTTOM,
                                                          (int)colors.GREEN, (int)sides.BACK,
                                                          (int)colors.ORANGE, (int)sides.RIGHT,
                                                              -1, -1, 1);
        }
